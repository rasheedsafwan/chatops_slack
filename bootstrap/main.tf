...
# The S3 bucket that will hold all future Terraform state files
...
resource "aws_dynamodb_table" "tf_lock" {
  name         = "chatopsbot-terraform-locks"
...
data "aws_iam_policy_document" "github_actions_assume" {
  statement {
    ...
    condition {
      ...
      values   = ["repo:rasheedsafwan/chatopsbot:*"]
    }
  }
}

resource "aws_iam_role" "github_actions" {
  name               = "chatopsbot-github-actions-role"
